...
export const products: Product[] = [
  ...
  },
  {
    ...
    variants: {
      colors: ['White', 'Navy', 'Black', 'Sage Green'],
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    },
    inStock: true,
  },
  {
    ...
    slug: 'merino-wool-blend-sweater',
    category: 'Clothing',
    subcategory: 'Men',
    price: 89.99,
    ...
    badge: 'Sale',
    description: 'Luxuriously soft Merino wool blend sweater that keeps you warm without bulk. Fine-gauge knit with a contemporary slim fit, perfect for layering. Temperature-regulating and naturally odor-resistant.',
    specifications: {
